            ...
            <div class="form">
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <select class="form-select" id="birthdate">
                ...
                <div class="mb-4">
                    ...
                    <select id="city" class="input-check form-select">
                        <option value="" selected disabled>請選擇</option>
                ...
                <div class="mb-4">
                    ...
                    <select id="district" class="input-check form-select">
                        <option value="" selected disabled>請選擇</option>
                ...
                <div class="mb-4">
                    ...
                    <input class="form-control" type="text" placeholder="資料自動帶入" aria-label="Disabled input example"
                        disabled>
